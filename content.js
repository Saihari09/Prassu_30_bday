...
*/
const REASONS = [
  { text: 'The way you laugh at your own jokes.', photo: '' },
  { text: 'You remember the small thing I mentioned long ago', photo: '' },
  { text: 'Your handwriting and attention to detail is something I admire.', photo: '' },
  { text: 'You make terrible coffee but the love you pour in it makes it so good.', photo: '' },
  { text: 'Your random dances and kink makes me feel the moment. ', photo: '' },
  { text: 'You ask follow-up questions when other people would have stopped listening.', photo: '' },
  { text: 'You\'re kind to people to do your best to fit in different places.', photo: '' },
  ...
  { text: 'You read the things out loud and put effort to understand concepts.', photo: '' },
  { text: 'You forgive me faster than I deserve.', photo: '' },
  { text: 'You make rooms feel warmer.', photo: '' },
  { text: 'You take photos of all our moments & I love that about you.', photo: '' },
  { text: 'You\'re funny in a way that sneaks up on people.', photo: '' },
  { text: 'You take care of plants like they have feelings.', photo: '' },
  { text: 'You cry for everything - can be reduced now that you are 30.', photo: '' },
  { text: 'You learnt to drive to help me out, I wish you continue it with confidence', photo: '' },
  { text: 'You give the best birthday celebration one could wish.', photo: '' },
  { text: 'You let me steal the blanket many times', photo: '' },
  { text: 'You make sure to give the best hugs and love to keep me going.', photo: '' },
  { text: 'You take efforts to keep in touch with friends and family and love that.', photo: '' },
  { text: 'You\'re honest, even when things go bad', photo: '' },
  { text: 'You can tell when something is wring with me before even I tell you.', photo: '' },
  { text: 'You believe in me on the days I forget how to.', photo: '' },
  { text: 'You make ordinary days feel like something.', photo: '' },
  { text: 'You make the best food and on the days when I am unable to.', photo: '' },
